...
vali_dir = '/cifar10/cifar-10-batches-py/test_batch'
...
def read_validation_data(visualization=False):
    '''
    ...
    if not visualization:
        ...
        validation_array = validation_array/255
