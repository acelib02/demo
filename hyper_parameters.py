# Original Code from Github: https://github.com/wenxinxu/resnet_in_tensorflow
# Changed tensorflow function calls to remove warnings.
# Modified data loading and preprocessing process.
# Fixes other bugs.
# ==============================================================================
...
tf.app.flags.DEFINE_string('version', 'Demo', '''A version number defining the directory to save
...
time''')
tf.app.flags.DEFINE_integer('decay_step0', 6000, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step1', 8000, '''At which step to decay the learning rate''')
...
tf.app.flags.DEFINE_string('ckpt_path', './ckpt/model.ckpt-100000', '''Checkpoint
directory to restore''')
tf.app.flags.DEFINE_boolean('is_use_ckpt', False, '''Whether to load a checkpoint and continue
training''')

tf.app.flags.DEFINE_string('test_ckpt_path', 'model.ckpt-9999', '''Checkpoint
directory to restore''')

tf.app.flags.DEFINE_string('f', '', 'kernel')
tf.app.flags.DEFINE_string('ckpt','./ckpt','''Where to save check points''')
tf.app.flags.DEFINE_string('round','','''The round name, use time if set null''')